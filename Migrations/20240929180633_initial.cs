    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthoredBooksBookId = table.Column<int>(type: "INTEGER", nullable: false),
                    AuthorsAuthorId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorBook", x => new { x.AuthoredBooksBookId, x.AuthorsAuthorId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorBook_Books_AuthoredBooksBookId",
                        column: x => x.AuthoredBooksBookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorBook_AuthorsAuthorId",
                table: "AuthorBook",
